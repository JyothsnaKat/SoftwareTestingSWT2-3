...
class Search():
    ...
    def __init__(self):
            ...
            try:
                ...
                if match:
                    ...
                    if self.min_age < 18 or self.max_age > 99:
                        raise ValueError(Fore.RED + "\nError: " + Fore.RESET + "Please enter a valid age range between 18 and 99.\n")
                    elif self.min_age > self.max_age or self.min_age == self.max_age:
                        raise ValueError(Fore.RED + "\nError: " + Fore.RESET + "Please enter a valid age range in the format 'min-max'(e.g. 20-30).\n")
                    break
                else:
                    raise ValueError(Fore.RED + "\nError:" + Fore.RESET +  "Please enter a valid age range in the format 'min-max'(e.g. 20-30).\n")
            ...
            try:
                ...
                if interest_num.lower() == 'done':
                    if len(self.interests) == 0:
                        print(Fore.RED + "\nError:" + Fore.RESET + "Please select atleast one interest or 'na' for no preference.\n") 
                        continue
                    else:
                        break
                elif interest_num.lower() == 'na':
                    print(Fore.YELLOW + "\nWarning:" + Fore.RESET + "Please note that on choosing na all the previously entered interests, if any will be dropped.\n")
                    self.interests = []
                    break
        ...
        while True:
            try:
                ...
                print(Fore.RED + "\nError:" + Fore.RESET + "Please enter a valid height between 55 and 300 cm. \n")
        ...
        while True:
            ...
            if self.smoking_preference.lower() == "yes" or self.smoking_preference.lower() == "no" or self.smoking_preference.lower() == "na":
                ...
                print(Fore.RED + "\nError:" + Fore.RESET + "Please enter 'yes' or 'no' or 'na' for no preference.\n")
        while True:
    ...
    def view(self,data,userID):
        ...
        while True:
            if not data:
                    print(Fore.MAGENTA + "No matches found according to the preferences entered.\n" + Style.RESET_ALL)
            ...
            #displaying all search results in a table
                ...
                if not flag:
                    print("Based on your preferred gender and other preferences you entered just now, here is a list of potential matches:")
                    print(table)
                    print("\n")
                    ...
                    if user_input == '1':
                        ...
                        while True:
                            ...
                            if not any(result[4]==user_id for result in data):
                                print(Fore.RED + "\nError:" + Fore.RESET + "Please enter User ID from the list.\n")
                                continue
                            for result in data:
                                if result[4]==user_id:
                                    profile = PrettyTable()
